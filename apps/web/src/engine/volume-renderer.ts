...
export const DEFAULT_CALIBRATION_C: CalibrationConfig = {
  position: { x: 0, y: 0, z: 0 },
  rotation: { x: 90, y: 0, z: 0 },
  scale: { x: 1.38, y: 1, z: 0.74 },
  axisMapping: { lateral: 'z', depth: 'y', track: 'x' },
  camera: {
    dist: 1.5,
    fov: 39,
    orbit: {
      posX: -0.3147419454483268,
      posY: -0.04419494521805738,
      posZ: 1.3503368680460759,
      targetX: 0.0011887836977719744,
      targetY: -0.01063765525335001,
      targetZ: 0.00014624293066423994,
    },
  },
  grid: { y: -0.5 },
  axes: { size: 0.8 },
