...
export const translations = {
  fr: {
    ...
    'home.feat1.desc': 'D\u00e9posez votre vid\u00e9o sonar MP4 et votre trace GPS (optionnel). ecos d\u00e9tecte automatiquement les m\u00e9tadonn\u00e9es.',
    ...
    'manifesto.s2.p2': 'ecos prend cette position au s\u00e9rieux : l\u2019enregistrement d\u2019\u00e9cran n\u2019est pas une copie d\u00e9grad\u00e9e de quelque chose de mieux. C\u2019est la forme la plus accessible, la plus partageable, la plus reproductible de l\u2019observation sonar.',
    ...
    'manifesto.cta': 'Commencer \u00e0 utiliser ecos',
    ...
    'docs.step2.body': 'Glissez-d\u00e9posez votre vid\u00e9o MP4 et fichier GPX (optionnel) dans l\u2019\u00e9tape d\u2019import. ecos lit les m\u00e9tadonn\u00e9es vid\u00e9o et parse la trace GPX automatiquement. Un bouton « test » permet de charger des fichiers d\u2019exemple.',
  ...
  en: {
    ...
    'home.feat1.desc': 'Drop your sonar MP4 and GPS track (optional). ecos auto-detects metadata.',
    ...
    'manifesto.s2.p2': 'ecos takes this position seriously: the screen recording is not a degraded copy of something better. It is the most accessible, most shareable, most reproducible form of the sonar observation.',
    'manifesto.s3.title': 'The perceptive archive',
    'manifesto.s3.p1': 'By combining a screen capture (MP4) with a simultaneous GPS trace (GPX), ecos builds a spatial volume -a three-dimensional reconstruction of what the sonar showed, placed in geographic context. This is not a bathymetric survey. It claims perceptive coherence.',
    ...
    'manifesto.s4.title': 'What ecos is not',
    'manifesto.s4.items': [
    ...
    'manifesto.s5.title': 'What ecos is',
    'manifesto.s5.items': [
    ...
    'manifesto.cta': 'Start using ecos',
    ...
    'docs.step2.body': 'Drag and drop your MP4 video and GPX file (optional) into the import step. ecos reads video metadata and parses the GPX track automatically. A "test" button lets you load sample files.',
